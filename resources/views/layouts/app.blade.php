...
<head>
    ...
    <title>comida de mascota a domicilio ººº PETDelivery </title>
    ...
    .navbar-brand>img {
        ...
        .c-Home.a-index .main .testimonials blockquote {
            border: 0;
        }
        blockquote {
            padding: 10px 20px;
        ...
        .c-Home.a-index .main .testimonials blockquote p {
            padding: 15px 20px;
            border-radius: 4px;
            font-size: 16px;
            position: relative;
        ...
        .c-Home.a-index .main section .inner {
            padding: 40px 0;
        }}
    </style>
